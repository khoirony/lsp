			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center" style="width:90px;">
						<a href="<?= base_url('Admin/setujukompetensi/' . $kom['id_user']); ?>"><i class="fas fa-check-square text-success fs-3"></i></a>
						<a href="<?= base_url('Admin/batalkompetensi/' . $kom['id_user']); ?>"><i class="fas fa-window-close text-danger fs-3"></i></a>
                    </td>
				</tr>
				<?php
				}

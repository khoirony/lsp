...
<div class="container-fluid">
	...
	<!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-fw fa-tasks"></i> <?= $title; ?><a href="<?= base_url('admin/editprofesi/'.$profesi['id_user']);?>" class="pb-2"><span class="badge bg-primary fs-6 ms-2">Edit</span></a><a href="<?= base_url('admin/hapusprofesi/'.$profesi['id_user']);?>" class="pb-2"><span class="badge bg-danger fs-6 ms-2">Hapus</span></a></h1>
